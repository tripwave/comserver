 ...
 * @version 1.0
 */
public interface IResourceFeed {
	void execute(IResourceSink sink);
	void addResourceSink(IResourceSink sink);
	void onClientAdded(IComserverNode connection);
	void onClientRemoved(IComserverNode connection);	
	void removeResourceSink(IResourceSink sink);
